...
public class UserController {
	...
	@ResponseBody
	public Map<String, Object> userSignInAndroid(@ModelAttribute("inUser") User inUser,
	...
	@RequestMapping("/loginAndRstPwd")
	@ResponseBody
	public Result loginAndRstPwd( String verificationCode,@ModelAttribute User inUser,
			HttpServletRequest request){
		Result result = new Result();
		
		result = userService.loginAndRstPwd(inUser,verificationCode);
		
		if(result.getErrorCode()==ServiceConstants.SERVICE_LOGIN_AND_RESET_PASSWORD_SUCCESS){
			result.setErrorCode(APIErrorCode.LOGIN_AND_RESET_PASSWORD_SUCCESS);
			result.setMessage("success");
		}else{
			result.setErrorCode(APIErrorCode.LOGIN_AND_RESET_PASSWORD_ERROR);
		}
