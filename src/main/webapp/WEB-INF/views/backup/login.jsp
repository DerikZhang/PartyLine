...
<div class="box">
		<div class="login-box">
			...
			<div class="form">
			<form action="${ctx}/login/web?partyID=${partyID }>" method="post">
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
							<input type="text" value="${phoneNumber }" id="phone_number" name="phone_number" class="form-control" placeholder="电话号码" />
						</div>
					</div>
				</div>
				<div class="form-group">
