...
<script type="text/javascript">
	...
	$.cookie('partyID',partyID,{expires:cookietime});
		...
		<div class="login-box">
			...
			<form action="${ctx}/sign/web" method="post" onsubmit="return checkValid();">
				<div class="form-group">
					<div class="col-xs-12" style="padding-right:11px;padding-left:11px;">
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
							<input style="width:80%" type="text" id="phone_number" name="phone_number" class="form-control" placeholder="手机号码" />
							<button id="verCode" type="button" style="height: 40px; float: right;">获取验证码</button>
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							...
							<input maxlength="6" type="text" id="verCode" name="verCode" class="form-control" placeholder="验证码" />
						</div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group form-actions">
					<div class="col-xs-4 col-xs-offset-4 ">
						...
						<a href="${ctx}/login">
							<button style="width:103px" type="button" class="btn btn-sm btn-info">
								返回登录
							</button>
						</a>
					</div>
