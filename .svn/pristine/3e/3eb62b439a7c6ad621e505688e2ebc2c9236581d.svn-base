			...
			<div class="form-group">
				<div class="col-xs-12  "style="padding-right:50px;padding-left:50px;">
					<div class="output-group">
						...
						<p class="text-center remove-margin">Party名称</p>
						<output type="text" id="partyName" value=""  name="partyName" class="form-control" />
					</div>
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-12  "style="padding-right:50px;padding-left:50px;">
					<div class="output-group">
						<span class="output-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
						<p class="text-center remove-margin">用户列表</p>
						<output type="text" id="userList" value=""  name="userList" class="form-control" />
					</div>
				</div>
			</div>
			<div class="form-group form-actions">
					<div class="col-xs-4 col-xs-offset-4 "style="padding-right:50px;padding-left:50px;">
						<img type="submit" id="qrimg"><span class="glyphicon glyphicon-off"></span></img>
					</div>
				</div>
		</form>
		</div>
